...
ThresA = 0.2  # intent-oriented factor (i.e., 0.25 for computation on end-device)
ThresB = 0.6  # intent-oriented factor (i.e., 0.45 for computation on edge and 0.3 on cloud)
...
for i in range(MAX_EPISODES):
    ...
    for j in range(MAX_EP_STEPS):
        ...
        tool.apply_action_MEC(a, N_OUT, ThresA, ThresB)
