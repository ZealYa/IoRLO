    ...
    def step(self, action):
        ...
        for item in action:
            if item == 0:
                ...
                self.state[state_pos] = pbl.mobilenet_latency_H_h()[state_pos]
                # self.state[state_pos] = pbl.mobilenet_latency_H_l()[state_pos]
            state_pos += 1
        ...
        # communication cost
        comm_cost_latency, comm_cost_energy = tool.comm_cost_mobilenet_D2D(action, N_OUT)  # mobilenet_d2d
