    ...
    def step(self, action):
        ...
        for item in action:
            ...
            if item == 1:
                ...
                self.state[state_pos] = pbl.res32_latency_E()[state_pos]
            else: # item == 3
                self.state[state_pos] = pbl.res32_latency_C()[state_pos]
            state_pos += 1
        ...
        # communication cost
        comm_cost_latency, comm_cost_energy = tool.comm_cost_res32_MEC(action, N_OUT)
